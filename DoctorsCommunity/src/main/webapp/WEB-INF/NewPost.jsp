...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary" style="display: flex; justify-content: space-between;">
      ...
      <div class="row justify-content-between">
	      		...
	      		<form:form action="/posts/new" method="post" modelAttribute="post">
	                ...
	                <div class="row">
	                    <div class="col-2" style="margin: 1rem 0;">
	                    	<input type="submit" value="submit" style="width:150px; height:40px; font-weight: bold; background-color: lighgrey; border:2px solid black; border-radius:10px;	" ></div>
	                	</div>
	            	</div>
         	  </form:form>
		  </div>
       ...
       <div class="row justify-content-between">
       		<h2 class="mt-5 mb-4">Quotes by some of our Doctors.</h2>
            <div class="col-8 mt-3" style="display:flex;">
				  ...
				  <div class="card-body">
				    <p class="card-text">"When wealth is lost, nothing is lost; when health is lost, something is lost; when character is lost, all is lost."</p>
				  </div>
				</div>
                   <div class="card mx-4" style="width: 15rem;">
