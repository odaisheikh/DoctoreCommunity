  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary" style="display: flex; justify-content: space-between;">
      ...
      <div class="row pt-5">
      		...
      		<h3>Welcome, Dr. <c:out value="${currentUser.username}"></c:out></h3>
      		<h5 class="mt-5">Your Advices</h5>
      </div>
      <div class="row justify-content-between p-3">
      		<div class="col-8 overflow-auto border border-dark" style="height:600px; border-radius:10px;">
					...
					<div class="m-3 p-2 overflow-auto" style="border:solid 2px LightGray; border-radius:15px; height: 150px;">
						<h3 class="text-start"><span style="font-size:15px; color:Gray;">Posted on <fmt:formatDate value="${comment.createdAt}" type="date" pattern="dd-MMM-yyyy"/></span></h3>
						<p style="font-size:20px;"><c:out value="${comment.content}"></c:out></p>
					</div>
					<div class="row text-end me-2">
						<a href="/posts/${comment.commentPost.id}"><button type="button" class="btn btn-outline-secondary">Visit Post</button></a>
					</div>
				</c:forEach>    
          	</div>
